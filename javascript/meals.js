...
let veganized = [
  //day1
  {
    ...
    breakfastSide: ["Milk tea", "banana"],
    lunch: "nshima",
    lunchside: ["kalembula", "spinach"],
    mealSunset: "portage",
    mealSunsetSide: ["milk", "banana"],
    eveningmeal: "nshima",
    eveningmealside: ["5 years(veg)", "chikanda"],
  },
  //day2
  {
    breakfast: "Avocado Toast",
    breakfastSide: ["Black tea", "Orange"],
    lunch: "nshima",
    lunchside: ["chinese rep", "brocoli"],
    mealSunset: "custard",
    mealSunsetSide: ["milk", "banana"],
    eveningmeal: "white rice",
    eveningmealside: ["brocoli", "milk"],
  },
  //day3
  {
    breakfast: "brown bread",
    breakfastSide: ["milk", "brocoli"],
    lunch: "sugar Rice",
    lunchside: ["milk", "Pair"],
    mealSunset: "Maize (sample)",
    mealSunsetSide: ["lemonade", "pair"],
    eveningmeal: "nshima",
    eveningmealside: ["spinach", "chikanda"],
  },
  //day4
  {
    breakfast: "Tobwa",
    breakfastSide: ["lemonade", "mangoes"],
    lunch: "nshima",
    lunchside: ["fried okra", "spinach"],
    mealSunset: "brown bread",
    mealSunsetSide: ["black tea", "lettuce"],
    eveningmeal: "fried rice",
    eveningmealside: ["fried okra", "orange"],
  },
  //day5
  {
    breakfast: "brown bread",
